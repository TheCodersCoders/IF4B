...
<head>
    ...
    <title>Edit {{ $air->jenis_air }}</title>
...
<body>
    <div class="container">
        <h1 class="text-center mb-3">Edit Data Air</h1>
        <form class="forms-sample " action="{{ route('air.update', $air->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('patch')
          <div class="form-group">
            <div class="mb-3 col-lg-6">
              ...
              <a href="{{ route('air.index') }}"><button class="btn btn-danger mt-2">Cancel</button></a>
        </form>
    </div>
