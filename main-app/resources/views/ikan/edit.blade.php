...
<head>
    ...
    <title>Edit {{ $ikan->nama_ikan }}</title>
...
<body>
    <div class="container">
        <h1 class="text-center mb-3">Edit Data Ikan</h1>
        <form class="forms-sample " action="{{ route('ikan.update', $ikan->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('patch')
          <div class="form-group">
            <div class="mb-3 col-lg-6">
                ...
                <textarea type="text" class="form-control" id="deskripsi" placeholder="deskripsi" value="{{ $ikan->deskripsi }}" name="deskripsi"> </textarea>
                <label>Foto</label>
