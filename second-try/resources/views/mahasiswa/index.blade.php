      ...
      <div class="card">
        <div class="card-body">
          ...
          <div class="d-flex justify-content-between">
            <form class="col-lg-12 rounded border-info border d-flex mb-2">
              <input type="text" name="searc" class="form-control" placeholder="">
            </form>
          </div>
         ...
         @endif
          <div class="table-responsive">
            ...
            <div class="mt-4">
              {{ $mahasiswas -> withQueryString()->links('pagination::bootstrap-4') }}
            </div>
          </div>
        </div>
      </div>
