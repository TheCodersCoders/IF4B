...
$mahasiswa = [
 ...
 echo"<table  align='center' style='background-color: #DDF7E3;'>
    ...
    echo "<tr><td colspan='4'>IPK</td><td colspan='5' align='center'>". getIPK($total_m, $total_k)."</td></tr>";
    echo "<tr style='background:#C2F9FF;'><td colspan='2' >Predikat</td><td colspan='4'>".getPredikatKelulusan($ipk, $mahasiswa)."</td></tr>";
    echo "<tr><td colspan='2' >Yudisium</td><td colspan='4'>".getSyaratYudisium($ipk, $adaE, $nilai_ta,$total_d)."</td></tr>";
    echo"</table>";
?>